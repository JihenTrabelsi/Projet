...
import '../adminDashboard/Contact.css';
	...
	return (
		<>
			<motion.form
				...
				// })}
			>
				<h5> Request For KYC </h5>

				<div className="Categorie_Formulaire">
					{/** FIRST NAME INPUT */}
                    {/* <label style={{color : "#014AAD"}}>Customer Name</label> */}
					<input
				...
				<br></br>
					...
					{/* --- EMAIL INPUT --- */}
                    {/* <label style={{color : "#014AAD"}}>Customer Email</label> */}
					<input
						// {...register('email', {
						// 	required: '* Ce champs est requis'
						// })}
...
<br></br>
{/* <label style={{color : "#014AAD"}}>Customer Phone</label> */}
  <input
						// {...register('prenom', {
						// 	required: '* Ce champs est requis'
						// })}
	...
	<br></br>
	{/* <label style={{color : "#014AAD"}}>Metamask Address</label> */}
	<input
						// {...register('telephone', {
						// 	required: '* Ce champs est requis',
						// 	pattern: {
					...
					/> */}
<br></br>
                    {/* <label style={{color : "#014AAD"}}>Notes</label> */}
